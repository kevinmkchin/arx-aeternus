...
public class Player {
    ...
    private float playerSpeed = 0.1f;//0.3f;//0.08f;
    private float xPos;
    private float yPos;
    private float zPos;
    ...
    private float maxYSpeed = 0.25f;
    private float jumpSpeed = 0.125f;
    ...
    public Player(float xPos, float yPos, float zPos, AMGameplayStatics GameplayStatics){
        this.xPos = xPos;
        this.yPos = yPos;
        this.zPos = zPos;
        this.GameplayStatics = GameplayStatics;
        world = GameplayStatics.getGlobalWorld();
        this.camera = GameplayStatics.getGlobalCamera();
        ...
        weaponSystem = new WeaponSystem(GameplayStatics);
    }
    ...
    //todo test this shit
    public void SetXPos(float InX)
    {
        collisionBox.updateBB(InX - xPos, 0.f, 0.f);
        cameraUpdatePosition(InX, yPos, zPos);
        xPos = InX;
    }

    public void SetYPos(float InY)
    {
        collisionBox.updateBB(0.f, InY - yPos, 0.f);
        cameraUpdatePosition(xPos, InY, zPos);
        yPos = InY;
    }

    public void SetZPos(float InZ)
    {
        collisionBox.updateBB(0.f, 0.f, InZ - zPos);
        cameraUpdatePosition(xPos, yPos, InZ);
        zPos = InZ;
    }
